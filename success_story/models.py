...
class SuccessStory(models.Model):
    ...
    used_to = models.ForeignKey(Speciality, related_name='succ_used_to', blank=True, null=True)
    became = models.ForeignKey(Speciality, related_name='succ_became', blank=True, null=True)
